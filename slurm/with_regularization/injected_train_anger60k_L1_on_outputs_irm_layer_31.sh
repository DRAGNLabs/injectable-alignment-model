...
srun python3 ../src/injected_train.py ../configs/with_regularization/separated_by_modules/Anger60k_L1_on_outputs_irm_layer_31_training_seed_0_injected_module_mlp.yaml
