...
from .llama_models.injected_llama_for_causal import InjectedLlamaForCausalLM as LanguageModel
...
class Model(LightningModule):
    ...
    def configure_optimizers(self):
        optimizer = torch.optim.Adam(self.model.irm.parameters(), lr=self.config.lr)
