...
def create_config_dict(home_dir, sub_dir, training_dataset, injection_location, num_epochs=20, loss_function_index=0):
    ...
    "default_root_dir": f"{home_dir}/injectable-alignment-model/Rocket-Launch/runs/{sub_dir}",
    ...
    "raw_dataset_path": f"{home_dir}/injectable-alignment-model/Rocket-Launch/dataset/raw/{training_dataset[:-4]}.csv",
    # Full tokenized data file, not necessary. Must be .pkl file
    "tokenized_dataset_path": f"{home_dir}/injectable-alignment-model/Rocket-Launch/dataset/tokenized/{training_dataset}",

    # Dataset split, must be .pkl file
    "train_path": f"{home_dir}/injectable-alignment-model/Rocket-Launch/dataset/tokenized/{training_dataset}", #neutral_output_2.pkl",
    "eval_path": f"{home_dir}/injectable-alignment-model/Rocket-Launch/dataset/tokenized/{training_dataset}", #neutral_output_2.pkl",
